# KokBisa — Discourse Annotation & Calibration Codebook v1.3
## Methodological Framework for Indonesian Science Communication Public Discourse

**Document Version:** 1.3 (Post-Calibration Adjudication Refinement)  
**Date:** 2026-08-24  
**Scope:** Annotation Protocol for Indonesian Public Discourse Corpus (IPDC)

**Changelog v1.3:**
- Validated decision tree priority hierarchy against 100 calibration samples.
- Re-affirmed boundary rules for `Question` vs `Suggestion` and `Correction` vs `Opinion`.
- No new taxonomical changes required (Kappa = 0.9122).
